...
void RRGLWidget::drawSTLCoordinates(int r, int g, int b, int a) {
  glPushMatrix();
  glLineWidth(1.5f);
  setupColor(r, g, b, a);
  glBegin(GL_LINES);
